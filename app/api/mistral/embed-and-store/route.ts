...
import { mistralVectorStore } from "@/utils/mistral-supabase";
...
export async function POST(request: Request) {
  try {
    ...
    const storedData = await mistralVectorStore.addDocuments(output);
    return formatResponse(storedData, "Data fetched successfully");
  } catch (error) {
